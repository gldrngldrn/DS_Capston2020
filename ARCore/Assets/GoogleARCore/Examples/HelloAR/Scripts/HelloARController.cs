...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        private void _InstantiateOnTouch()
        {
            ...
            raycast = FirstPersonCamera.ScreenPointToRay(Input.GetTouch(0).position);
            // 오브젝트 움직임
        ...
        private void _Delete()
        {
            ...
            if ((Time.time - lastTap) < tapTime)
            {
                ...
                {
                    if (raycastHit.transform.gameObject.name.Contains("Picture"))
                    {
                ...
                if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
                {
                    if (CurrentNumberOfGameObjects < numberOfGameObjectsAllowed)
                    {
                        ...
                        else
                        {
                            ...
                            print(CurrentNumberOfGameObjects);
                            ARObject.name = "Picture";
                            print(ARObject.name);
                        }
                    }
                }
